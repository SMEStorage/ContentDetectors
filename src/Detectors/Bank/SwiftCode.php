...
class SwiftCode extends Detector implements DetectorInterface
{
    ...
    // https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2 table of ISO 3166-1 alpha-2 codes 
    private $countryIsoCodes = 'AA  AB AC 	AD 	AE 	AF 	AG 	AH 	AI 	AJ 	AK 	AL 	AM 	AN 	AO 	AP 	AQ 	AR 	AS 	AT 	AU 	AV 	AW 	AX 	AY 	AZ
...
ZA 	ZB 	ZC 	ZD 	ZE 	ZF 	ZG 	ZH 	ZI 	ZJ 	ZK 	ZL 	ZM 	ZN 	ZO 	ZP 	ZQ 	ZR 	ZS 	ZT 	ZU 	ZV 	ZW 	ZX 	ZY 	ZZ';
    ...
    public function __construct() {
        $this->countryIsoCodes = preg_replace("/\s+/", "-", $this->countryIsoCodes);
        $this->countryIsoCodes = explode("-", $this->countryIsoCodes);
    }
    ...
    {
        $countryCode  = substr($match, 4, 2);
        return in_array($countryCode, $this->countryIsoCodes);
    }
